...
const usernameHelper = document.getElementById("nome-helper");
...
usernameInput.addEventListener("change", (e) => {
  ...
  const typeInput = isNaN(e.target.value)
  console.log(typeInput);
// Valida menor que 3 caracteres caso verdadeiro
  if((typeInput == true) && (valorInput.length >= 3)) {
...
// Valida menor que 3 caracteres caso falso
        ...
        emailHelper.innerText = `E-mail deve conter "@" e ".com `
